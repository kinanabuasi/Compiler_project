...
elevatedButton: ElevatedButton OQFUNC OnPressed TOWPOIT OQFUNC  CQFUNC OQCLASS (navigatTo)? CQCLASS COMA1 CHILD TOWPOIT title CQFUNC COMA1;

navigatTo: NavigatTo OQFUNC CONTEXTE COMA1 ID CQFUNC COMA ; //STRING -> Screen name which we want to go
