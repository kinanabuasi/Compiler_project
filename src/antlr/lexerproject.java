// Generated from lexerproject.g4 by ANTLR 4.10.1
...
public class lexerproject extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"COTATION", "COMA", "QoOrSmal", "QcOrBig", "SmalOrEQUAL", "BigOrEQUAL", 
			"SlashOrDivision", "DOTSLASH", "TOWDOTSLASH", "COMA1", "DOTE", "MULT", 
			"SUM", "MINUS", "EQUAL", "EqualEqual", "NotEqual", "DOUBLE_ZERO", "OPEN_ARCH_LIST", 
			"CLOSE_ARCH_LIST", "OQCLASS", "CQCLASS", "OQFUNC", "CQFUNC", "BLUSBLUS", 
			"MINUSMINUS", "TOWPOIT", "QUESTION_MARK", "AT", "AROW", "ADER_SCORE", 
			"Dolar", "STRING", "StringTitelWithDolar", "Target", "NUMBER", "DoubleNUMBER", 
			"ID", "INT", "EXP", "WS"
		};
	}
