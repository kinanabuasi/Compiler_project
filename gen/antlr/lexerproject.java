// Generated from C:/Users/VISION/IdeaProjects/Compiler_Project_V4/src/antlr\lexerproject.g4 by ANTLR 4.10.1
package antlr;
...
public class lexerproject extends Lexer {
	...
	public static final int
		...
		LIB=83, IMAGES=84, PNG=85, SizedBox=86, Expanded=87, CONTEXTE=88, NavigatTo=89, 
		COTATION=90, COMA=91, QoOrSmal=92, QcOrBig=93, SmalOrEQUAL=94, BigOrEQUAL=95, 
		SlashOrDivision=96, DOTSLASH=97, TOWDOTSLASH=98, COMA1=99, DOTE=100, MULT=101, 
		SUM=102, MINUS=103, EQUAL=104, EqualEqual=105, NotEqual=106, DOUBLE_ZERO=107, 
		OPEN_ARCH_LIST=108, CLOSE_ARCH_LIST=109, OQCLASS=110, CQCLASS=111, OQFUNC=112, 
		CQFUNC=113, BLUSBLUS=114, MINUSMINUS=115, TOWPOIT=116, QUESTION_MARK=117, 
		AT=118, AROW=119, ADER_SCORE=120, Dolar=121, STRING=122, StringTitelWithDolar=123, 
		Target=124, NUMBER=125, DoubleNUMBER=126, ID=127, WS=128;
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"IMPORT", "Package", "VAR", "LIST", "BOOL_TYPE", "Double_TYPE", "INT_TYPE", 
			"STRING_TYPE", "FINAL", "LATE", "VOID", "DOTEDART", "TRUE", "FALSE", 
			"IF", "NULL", "ABSTRACT", "CLASS", "RETURN", "PRINT", "MAP", "FOR", "EXTENDES", 
			"StatefulWidget", "StatelessWidget", "Const", "Key", "Super", "Override", 
			"State", "Build", "CreateState", "Widget", "BUILD", "ITEM", "ITEMBUILDER1", 
			"Scaffold", "AppBar", "AppBar1", "Title", "TEXT", "BODY", "Width", "Hieght", 
			"Only", "TOP", "Center", "ROW", "Children", "Container", "List_View", 
			"Builder", "GestureDetector", "COLUMN", "Length", "Index", "ONTAP", "SetState", 
			"Color", "Colors", "GRAY", "Padding", "Padding_BigP", "EdgeInsets", "All", 
			"ObscureText", "TextField", "Decoration", "InputDecoration", "Border", 
			"OutlineInputBorder", "LabelText", "HintText", "Boxdecoration", "BorderRadius", 
			"BorderRadius1", "Circular", "ElevatedButton", "OnPressed", "CHILD", 
			"Image", "ASSET", "LIB", "IMAGES", "PNG", "SizedBox", "Expanded", "CONTEXTE", 
			"NavigatTo", "COTATION", "COMA", "QoOrSmal", "QcOrBig", "SmalOrEQUAL", 
			...
			"NUMBER", "DoubleNUMBER", "ID", "INT", "EXP", "WS"
		};
	}
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"CONTEXTE", "NavigatTo", "COTATION", "COMA", "QoOrSmal", "QcOrBig", "SmalOrEQUAL", 
			"BigOrEQUAL", "SlashOrDivision", "DOTSLASH", "TOWDOTSLASH", "COMA1", 
			"DOTE", "MULT", "SUM", "MINUS", "EQUAL", "EqualEqual", "NotEqual", "DOUBLE_ZERO", 
			"OPEN_ARCH_LIST", "CLOSE_ARCH_LIST", "OQCLASS", "CQCLASS", "OQFUNC", 
			"CQFUNC", "BLUSBLUS", "MINUSMINUS", "TOWPOIT", "QUESTION_MARK", "AT", 
	...
	public lexerproject(CharStream input) {
		super(input);
		_interp = new LexerATNSimulator(this,_ATN,_decisionToDFA,_sharedContextCache);
	}

	@Override
	public String getGrammarFileName() { return "lexerproject.g4"; }
